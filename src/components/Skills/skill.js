...
export default function SkillList() {
  const skill_list = [
    ...
    { id: { main: "bg-3", icon: "fab fa-html5" }, title: "HTML" },
    { id: { main: "bg-4", icon: "fab fa-css3" }, title: "CSS" },
    { id: { main: "bg-5", icon: "fab fa-react" }, title: "React JS" },
    { id: { main: "bg-6", icon: "fab fa-data" }, title: "MySQL" },
    { id: { main: "bg-1", icon: "fab fa-data" }, title: "RestAPI" },
    { id: { main: "bg-2", icon: "fab fa-data" }, title: "Tailwind CSS" },
    { id: { main: "bg-3", icon: "fab fa-data" }, title: "C#" },
    { id: { main: "bg-4", icon: "fab fa-data" }, title: ".NET" },
  ];
